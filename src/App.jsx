...
function App() {
  ...
  const [cardClicked,setCardClicked] = createSignal(false);
  const [arrPassed, setArrPassed ] = createSignal([])
  ...
  return (
    ...
    <div class="relative h-[725px] max-h-[725px] w-[1534px] bg-gray-800  flex items-center justify-center overflow-hidden">
      {/* {isFullScreen() && (
      ...
      >
        ...
        <section id="skills" class="absolute top-[5%] left-[5%] transform -rotate-6 z-0">
          ...
          <div className=" group absolute top-[130%] -left-[24%] bg-white w-full h-[120px] p-4 rotate-12 shadow-black shadow-md" onClick={()=>{openCard("lang")}}>            
            <p class="font-mono text-gray-800 text-md">Languages</p>
                  <div>
                    <div className="absolute top-[42%] w-10 h-10 rounded-full  border-2 border-white bg-white z-40 hover:scale-125">
                  ...
                  <div className="absolute z-100 -bottom-4 left-[24%] opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100 hover:block bg-black text-white text-md rounded-md px-2 py-1">
                      Click me
                  </div>
            </div>
          ...
          {/* web technologies */}
          <div className="absolute top-[10%] left-[144%] bg-white w-full h-[120px] p-4 rotate-12 shadow-black shadow-md">
            <p className="font-mono text-gray-800 mb-2 text-sm">Web Technologies</p>
            <div>
                <div className="absolute w-10 h-10 rounded-full z-50 border-1 p-[3px] border-white bg-white">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="full" height="full" viewBox="0 0 48 48">
                    <path fill="#E65100" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z"></path><path fill="#FF6D00" d="M24 8L24 39.9 35.2 36.7 37.7 8z"></path><path fill="#FFF" d="M24,25v-4h8.6l-0.7,11.5L24,35.1v-4.2l4.1-1.4l0.3-4.5H24z M32.9,17l0.3-4H24v4H32.9z"></path><path fill="#EEE" d="M24,30.9v4.2l-7.9-2.6L15.7,27h4l0.2,2.5L24,30.9z M19.1,17H24v-4h-9.1l0.7,12H24v-4h-4.6L19.1,17z"></path>
                    </svg>
                </div>
                <div className="absolute w-10 h-10 bg-white  p-[3px] top-[38%] left-[25%]  rounded-full z-30">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="full" height="full" viewBox="0 0 48 48">
                ...
                <div className="absolute w-10 bg-white h-10 border-2 border-white top-[38%] p-[3px] left-[42%]  rounded-full z-20">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="full" height="full" viewBox="0 0 48 48">
                  <path fill="#00acc1" d="M24,9.604c-6.4,0-10.4,3.199-12,9.597c2.4-3.199,5.2-4.398,8.4-3.599 c1.826,0.456,3.131,1.781,4.576,3.247C27.328,21.236,30.051,24,36,24c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.6 c-1.825-0.456-3.13-1.781-4.575-3.247C32.672,12.367,29.948,9.604,24,9.604L24,9.604z M12,24c-6.4,0-10.4,3.199-12,9.598 c2.4-3.199,5.2-4.399,8.4-3.599c1.825,0.457,3.13,1.781,4.575,3.246c2.353,2.388,5.077,5.152,11.025,5.152 c6.4,0,10.4-3.199,12-9.598c-2.4,3.199-5.2,4.399-8.4,3.599c-1.826-0.456-3.131-1.781-4.576-3.246C20.672,26.764,17.949,24,12,24 L12,24z"></path>
                  </svg>
                </div>
                <div className="absolute w-10 bg-white h-10 top-[38%] left-[58%] p-[7px]  rounded-full z-10">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="full" height="full" viewBox="0 0 50 50">
                ...
                <span className=" absolute top-[43%] left-[76%] bg-green-500 px-2 py-1 rounded text-sm text-gray-900">+1</span>
          ...
          <div className="absolute top-[24%] left-[244%] bg-white w-full h-[120px] p-4 -rotate-11 shadow-black shadow-md">
            ...
            <div className="absolute top-[47%] left-[25%] w-10 h-10 rounded-full z-40 border-[2px] border-white p-[3px] border-white bg-white" >
            ...
            <div className="absolute top-[47%] left-[45%] w-10 h-10 rounded-full z-30 border-[2px] border-white p-[3px] border-white bg-white" >
            ...
            <div className="absolute top-[47%] left-[65%] w-10 h-10 rounded-full z-20 border-[2px] border-white p-[3px] border-white bg-white" >
          ...
          <div className="absolute top-[135%] left-[104%] bg-white w-full h-[120px] p-4 rotate-12 shadow-black shadow-md">
        ...
        {cardClicked() && <Section data = {arrPassed()}></Section>}
