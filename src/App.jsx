    ...
    <div class="relative h-[725px] max-h-[725px] w-[1534px] bg-gray-800  flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <section id="skills" class="absolute top-[5%] left-[5%] transform -rotate-6 z-0">
          ...
          <div className="absolute top-[130%] -left-[24%] bg-white w-full h-[120px] p-4 rotate-12 shadow-black shadow-md">
          <div className="group">
            ...
            <p class="font-mono text-gray-800 text-md">Languages</p>
                  ...
                  <span className="absolute z-100 -bottom-8 left-[50%] transform -translate-x-1/2 group-hover:scale-125 group-hover:block bg-black text-white text-md rounded-md px-2 py-1">
                    Click me
                  </span>
            </div>
